...
def test_readme_leads_with_native_alpha_downloads() -> None:
    ...
    for phrase in (
        ...
        "DEVSIM",
        "Sentaurus",
        "v0.1.0-alpha.2/Agent-Kronig-0.1.0-alpha.2-linux-x64.AppImage",
        "v0.1.0-alpha.2/Agent-Kronig-0.1.0-alpha.2-win-x64.exe",
        "v0.1.0-alpha.2/Agent-Kronig-0.1.0-alpha.2-mac-x64.dmg",
        "v0.1.0-alpha.2/Agent-Kronig-0.1.0-alpha.2-mac-arm64.dmg",
    ):
        assert phrase in readme
        if "v0.1.0-alpha.2/" in phrase:
