...
def test_repository_release_identity_is_alpha_3() -> None:
    identity = load_release_identity(ROOT, "v0.1.0-alpha.3")

    assert identity.version == "0.1.0-alpha.3"
    assert identity.tag == "v0.1.0-alpha.3"
