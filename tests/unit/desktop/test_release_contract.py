...
def test_repository_release_identity_is_alpha_4() -> None:
    identity = load_release_identity(ROOT, "v0.1.0-alpha.4")

    assert identity.version == "0.1.0-alpha.4"
    assert identity.tag == "v0.1.0-alpha.4"
