...
def test_repository_release_identity_is_alpha_5() -> None:
    identity = load_release_identity(ROOT, "v0.1.0-alpha.5")

    assert identity.version == "0.1.0-alpha.5"
    assert identity.tag == "v0.1.0-alpha.5"
