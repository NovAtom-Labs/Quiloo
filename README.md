...
<p align="center">
  <a href="https://github.com/NovAtom-Labs/Quiloo/releases/tag/v0.1.0-alpha.7">Alpha release</a>
  · <a href="INSTALLATION.md">Installation</a>
  · <a href="docs/architecture.md">Architecture</a>
  · <a href="docs/operations/desktop-application.md">Desktop operations</a>
</p>

> **Alpha software:** Agent Kronig 0.1.0 Alpha 7 is an early research pilot. Packages are currently unsigned, updates are manual, and scientific output must be reviewed by a qualified researcher before it informs device, process, or fabrication decisions.
...
| --- | --- | --- |
| Linux x86-64 | [AppImage](https://github.com/NovAtom-Labs/Quiloo/releases/download/v0.1.0-alpha.7/Agent-Kronig-0.1.0-alpha.7-linux-x64.AppImage) or [Debian package](https://github.com/NovAtom-Labs/Quiloo/releases/download/v0.1.0-alpha.7/Agent-Kronig-0.1.0-alpha.7-linux-x64.deb) | AppImage is self-contained |
| Windows x86-64 | [NSIS installer](https://github.com/NovAtom-Labs/Quiloo/releases/download/v0.1.0-alpha.7/Agent-Kronig-0.1.0-alpha.7-win-x64.exe) | [ZIP](https://github.com/NovAtom-Labs/Quiloo/releases/download/v0.1.0-alpha.7/Agent-Kronig-0.1.0-alpha.7-win-x64.zip) |
...
- [Alpha 7 release notes](docs/releases/v0.1.0-alpha.7.md)
